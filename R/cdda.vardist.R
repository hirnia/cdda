## ------------------------------------------------------------------------------------------------------------------ ##
## File:     cdda.vardist.R
## Purpose:  Source code for CDDA variance tests.
##           Requires packages "dHSIC", "lmtest", "boot"
...
cdda.vardist <- function(formula = NULL, pred = NULL, mod = NULL, modval = NULL,
  ...
  ##             test <- y ~ x * mod + z
  ##             cdda.vardist(test, pred = "x", mod = mod, modval = "mean", data = my.data)
  ## -----------------------------------------------------------------------------------------------
